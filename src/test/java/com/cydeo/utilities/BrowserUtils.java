...
public class BrowserUtils {
    ...
    /**
     * This method will accept a group of radio buttons a s a List <WebElements>
     *     it will loop through the List,and click to the radio button with providede attribute value</>
     * @param radioButtons
     * @param attributeValue
     */
    public static void clickRadioButton(List<WebElement> radioButtons, String attributeValue){
        for(WebElement each: radioButtons){// go into the loop and find and click not returning anything
