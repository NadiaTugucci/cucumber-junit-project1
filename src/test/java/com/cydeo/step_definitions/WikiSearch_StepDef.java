...
public class WikiSearch_StepDef {
    ...
    public void userSeesIsInTheMainHeader(String arg0) {
        Assert.assertEquals("Title verification is failed!",arg0, wikiSearchPage.headerText.getText());
    }
    @Then("User sees {string} is in the image header")
    public void userSeesIsInTheImageHeader(String arg0) {
        Assert.assertEquals("Title verification is failed!",arg0, wikiSearchPage.headerImageText.getText());
    }
