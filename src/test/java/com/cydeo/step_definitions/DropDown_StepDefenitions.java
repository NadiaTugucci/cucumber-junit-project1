...
import com.cydeo.pages.Dropdown_Pages;
...
public class DropDown_StepDefenitions {
...
//        Select select = new Select(Dropdown_Pages.monthDropdown);
//
...
//        }
       ...
       List <String> actualOptionsAsString= BrowserUtils.dropdownOptionsAsString(Dropdown_Pages.monthDropdown);
